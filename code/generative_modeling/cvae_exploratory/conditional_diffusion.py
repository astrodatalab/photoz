...
TRAIN_PATH = f'/data/HSC/HSC_v6/step3/5x127x127_training_max_2.hfd5'
TEST_PATH = f'/data/HSC/HSC_v6/step3/5x127x127_testing_max_2.hfd5'
...
beta = np.linspace(max_noise / timesteps, max_noise, timesteps) ** 2
...
unet.save_weights('/data3/Billy/unnormalized_weights_full_quadratic_weighted_4.csv')


# In[20]:


unet.load_weights('/data3/Billy/unnormalized_weights_full_quadratic_weighted_4.csv')
...
hf = h5py.File('/data3/Diffusion/127x127_diffusion_generated_3.hdf5', 'a')
