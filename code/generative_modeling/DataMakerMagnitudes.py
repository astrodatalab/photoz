    ...
    def __get_dataset_items(
        ...
        with h5.File(self.src, "r") as file:
            if dataset is not None:
                ...
                return ([file[self.X_key][indices], [file['g_cmodel_mag'][indices][0], file['r_cmodel_mag'][indices][0], file['i_cmodel_mag'][indices][0], file['z_cmodel_mag'][indices][0], file['y_cmodel_mag'][indices][0]]], file[self.X_key][indices])
